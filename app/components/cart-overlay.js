...
const CartOverlay = ({ onClose }) => {
    ...
    return (
        <div className='bg-[#121212] fixed max-sm:w-[100%] max-sm:right-0 w-[368px] h-[380px] main-overlay-cart text-white border-white border-x-[1px] border-b-[1px] px-[35px] py-[25px] pt-0'>
