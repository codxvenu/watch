 ...
 return (
    <div className="main-nav bg-[#121212] z-50">
        <div className="social bg-[#121212] h-[38px] border-b-[0.25px] border-b-[#ffffff14] flex justify-between items-center" >
            ...
            <p className='text-white text-[13px] m-l-[110px]'>Use code "Shree25" and get free shipping on first order</p>
        ...
        <ul className="icons">
            <span className='search-span'>
              <input type="text"  onChange={
                ...
                handleChange
                } className={ search ? "search-hovers search-hover z-10":"search-hover z-10"} name="" placeholder="Search..." />
...
{searched.map((swatch,index)=>(
    ...
    <li className="flex gap-5 p-4 " key={swatch.id} onClick={()=>{handleProduct(index)}}>
              ...
              <svg id="search-i" className="ml-[-30px] z-10" onClick={()=>{search===false ?setSearch(true):setSearch(false)}} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" ><path d="M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z"/></svg>
              </span>
            <a href="/login"><span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512l388.6 0c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304l-91.4 0z"/></svg></span>
            </a><a href="/cart"><span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M160 112c0-35.3 28.7-64 64-64s64 28.7 64 64l0 48-128 0 0-48zm-48 48l-64 0c-26.5 0-48 21.5-48 48L0 416c0 53 43 96 96 96l256 0c53 0 96-43 96-96l0-208c0-26.5-21.5-48-48-48l-64 0 0-48C336 50.1 285.9 0 224 0S112 50.1 112 112l0 48zm24 48a24 24 0 1 1 0 48 24 24 0 1 1 0-48zm152 24a24 24 0 1 1 48 0 24 24 0 1 1 -48 0z"/></svg></span></a>
        </ul>
      </nav>
    </div>
  )
